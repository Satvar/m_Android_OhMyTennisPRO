...
public class StageDTO {
    ...
    public void setData( StageData dataObject ) {
    ...
    public class StageData {
        ...
        @Expose
        ArrayList<StageCourse> course = new ArrayList<StageCourse>();

        public ArrayList<StageCourse> getCourse() {
            return course;
        }

        public void setCourse(ArrayList<StageCourse> course) {
            this.course = course;
        }

    }

    public static class StageCourse{
        @SerializedName("id")
        @Expose
        private String id;
