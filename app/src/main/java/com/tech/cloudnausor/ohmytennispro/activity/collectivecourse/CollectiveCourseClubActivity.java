...
public class CollectiveCourseClubActivity extends AppCompatActivity {
    ImageView GoBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collective_course_club);
...
//        });
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(CollectiveCourseClubActivity.this, HomeActivity.class);
